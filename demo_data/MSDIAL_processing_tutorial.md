...
![Project parameters](images/01_project-parameters.png)
...
![Annotation cutoff settings](images/02_annotation-cutoff.png)
...
![Alignment parameters](images/03_alignment-parameters.png)
...
![MS-CleanR peak filtering](images/04_mscleanr-filtering.png)
...
![Peak spot filters](images/05_peak-spot-filters.png)
...
![Peak curation menu](images/06_peak-curation-menu.png)

EICs overlay allows manual alignment across multiple files.

![EICs overlay](images/07_eics-overlay.png)

Sample table allows manual alignment of individual files. Double-click on the chromatogram to perform manual peak picking.

![Sample table](images/08_sample-table.png)

![Manual peak picking](images/09_manual-peak-picking.png)
...
![MS/MS reference vs representative](images/10_msms-reference-vs-representative.png)
...
![Peak spot table with checkmarks](images/11_peak-spot-table-checkmarks.png)
...
![Incorrect identification example](images/12_incorrect-id-example.png)
...
Peak (1):
![Isomeric TG, peak 1](images/13_isomeric-tg-peak1.png)

Peak (2):
![Isomeric TG, peak 2](images/14_isomeric-tg-peak2.png)

Peak (3):
![Isomeric TG, peak 3](images/15_isomeric-tg-peak3.png)
...
![File property setting](images/16_file-property-setting.png)
...
![LOWESS normalisation](images/17_normalisation.png)
...
![Tag filter](images/18_tag-filter.png)
...
![Export alignment](images/19_export-alignment.png)
